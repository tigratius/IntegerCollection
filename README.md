...
1) Скачать приложение 
	a) Перейти в репозиторий по ссылке https://github.com/tigratius/bitbucket  
	b) Кликнуть зеленую кнопку "Clone or Download" в правой верхней части страницы. 
	с) Распаковать архиватором
